...
static double MismatchRateThreshold=0.6; //not too many mismatch 
...
int main(int argc, char* argv[])
{
  ...
  const char *opts = "hva:b:f:r:g:e:t:m:s:k:n:p:q:l:i";
  ...
  if(isotype_flag)
    {
      cout<<"\toutput data by isotypes:TRUE"<<endl;
    }
  else
    {
      cout<<"\toutput data by isotypes:FALSE"<<endl;
    }
